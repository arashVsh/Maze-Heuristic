...
# Pieter Abel (pabbeel@cs.berkeley.edu).
...
class GameStateData:
    ...
    def __init__(self, prevState=None):
        ...
        if prevState != None:
            ...
            self.agentStates = copyAgentStates(prevState.agentStates)
    ...
    def __str__(self):
        ...
        for x in range(width):
            for y in range(height):
                ...
                map[x][y] = _foodWallStr(food[x][y], walls[x][y])
        ...
        for agentState in self.agentStates:
            ...
            if agentState.isPacman:
                map[x][y] = _pacStr(agent_dir)
            else:
                map[x][y] = _ghostStr(agent_dir)
